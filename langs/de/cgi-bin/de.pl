...
'guardian empty input' => 'Fehlende Eingabe: Bitte geben Sie einen gültigen Host oder Netzerk an.',
'guardian invalid alertfile' => 'Der angegebene Pfad zum "Alert file" ist ungültig.',
'guardian invalid blockcount' => 'Ungültige Anzahl: Bitte verwenden Sie eine natürliche Zahl größer als Null an.',
'guardian invalid blocktime' => 'Ungültige Blockzeit: Bitte verwenden Sie eine natürliche Zahl größer als Null an.',
'guardian invalid logfile' => 'Der angegebene Pfad zur "Ignore file" ist ungültig.',
...
'guardian not running no hosts can be blocked' => 'Guardian ist nicht gestartet. Hosts werden nicht geblockt.',
